/* *
* hw04q1 - Student Records
*
* Completion time : 15 hours
*
* @author Melissa Mandyck, Acuna code
* @ v ersion January 21,2024
*/
// CSE240 Homework
...
int addSort(char* studentName_input, char* major_input, char* schoolYear_input, unsigned int studentID_input)
{
	if (count >= MAX_STUDENTS) {
		return 2; // Student list is full
	}
	// Check for existing students
	for (int i = 0; i < count; i++) {
		if (strcmp(list[i].studentName, studentName_input) == 0) {
			return 0; // Student already in the list
		}
	}
	...
	// Sorting Student name Alphabetically
	...
	return 1; // Student added and list sorted
}
